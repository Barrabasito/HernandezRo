...
<body>
     ...
     <div class="buscador">
        ...
        <a class="todo" href="index.php">Todos</a>
    ...
    <thead>
        ...
        <tr align="center"><th>Id</th><th>Nombre</th><th>Cantidad</th></tr>
        </thead>
    <?php
     $conexion= mysqli_connect("localhost","root","","items") or die("No se pudo conectar al localhost");
     $consulta= "SELECT Id,Nombre,Cantidad FROM itemsminecraft WHERE Id LIKE '$buscar' '%' OR  Nombre LIKE '$buscar' '%' OR  Cantidad LIKE '$buscar' '%' ";
